...
class BuyFragment : BaseFragment<FragmentBuyBinding>(), BuyFragmentActionListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fiatDrawerFragmentTransaction.replace(R.id.buy_left_drawer, buyFiatDrawerFragment)
        ...
        with(binding) {
            ...
            buyPartnersAdapter.setPartners(mutableListOf(
                BuyPartnersItem(
                    ...
                    type = R.string.buy_partners_item_type_bank_card,
                    namePartners = R.string.buy_partners_item_name_simplex
                ),
                BuyPartnersItem(
                    icon = R.drawable.ic_partners_xanpool,
                    type = R.string.buy_partners_item_type_bank_card,
                    namePartners = R.string.buy_partners_item_name_xanpool
                ),
                BuyPartnersItem(
                    icon = R.drawable.ic_partners_moonpay,
                    type = R.string.buy_partners_item_type_apple_pay,
                    namePartners = R.string.buy_partners_item_name_moonpay
                ),
                BuyPartnersItem(
                    icon = R.drawable.ic_partners_banxa,
                    type = R.string.buy_partners_item_type_bank_card,
                    namePartners = R.string.buy_partners_item_name_banxa
                ),
                BuyPartnersItem(
                    icon = R.drawable.ic_partners_mercuryo,
                    type = R.string.buy_partners_item_type_bank_card,
                    namePartners = R.string.buy_partners_item_name_mercuryo
                ),
                BuyPartnersItem(
                    icon = R.drawable.ic_partners_simplex,
                    type = R.string.buy_partners_item_type_bank_card,
    ...
    override fun onFiatItemClick(fiat: Fiat) {
        binding.buyDrawerLayout.close()
        viewModel.setFiatChosen(fiat)
    }

    override fun onFiatBtnClick() {
        binding.buyDrawerLayout.openDrawer(Gravity.LEFT)
    }
